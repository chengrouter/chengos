...
Old templates in `deploy/skills/templates` are historical and may contain stale node snapshots. These V2 templates intentionally do not embed old `inputs` / `outputs` arrays. Use the live node API as source of truth:
